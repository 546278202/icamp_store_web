...
(function() {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,
        toolbars: [
                ["bold", "italic", "underline", "forecolor", "shadowcolor", "backcolor", "justifyleft", "justifycenter", "justifyright", 'justifyjustify', "indent", 'outpadding', "rowspacingtop", 'rowspacingbottom', "lineheight", 'letterspacing'],
                ['cleardoc', "fontfamily", "fontsize", 'strikethrough', "inserttable", 'background', 'wordimage', "uploadword", "insertimage", 'music', 'insertvideo', "horizontal", "removeformat", 'formatmatch', "autotypeset"],
                ["source", 'blockquote', 'link', 'insertparagraph', 'remotecontent', 'spechars', 'emotion', 'insertorderedlist', 'insertunorderedlist', 'directionalityltr', 'directionalityrtl', "undo", "redo", 'searchreplace', 'fullscreen', 'message', 'imgstyle']
            ]
        ...
        'letterspacing': [0, 0.25, 0.5, 1, 2, 3, 4, 5]
