<template>
  <div class="dashboard-container">
    ...
    <el-table fit ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" border @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="num" label="部门名称" align="center"></el-table-column>
      <el-table-column prop="num" label="职能描述" align="center"></el-table-column>
      <el-table-column prop="num" label="成员数量" align="center"></el-table-column>
