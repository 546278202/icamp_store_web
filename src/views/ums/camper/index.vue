  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="结束时间：">
            <el-date-picker class="input-width" v-model="listQuery.endDate" value-format="yyyy-MM-dd" type="date" placeholder="请选择时间">
            </el-date-picker>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="orderTable" :data="list" style="width: 100%;" @selection-change="handleSelectionChange" border>
        ...
        <el-table-column prop="camperName" label="姓名(中文)" width="160" align="center"> </el-table-column>
           <el-table-column prop="camperNameEn" label="姓名(英文)" width="160" align="center"> </el-table-column>
        <el-table-column prop="sex" label="性别" align="center">
          <template slot-scope="scope">{{scope.row.sex | sexFilter}}</template>
        </el-table-column>
        <el-table-column prop="birth" label="生日" align="center" width="180"></el-table-column>
        <el-table-column prop="level" label="地址" align="center">
          <template slot-scope="scope">{{scope.row.areaId | addressFilter}}</template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleViewOrder(index, row) {
      this.$router.push({ path: '/ums/userDetail', query: { id: row.userId } })
    },
    ...
    getList() {
      ...
      this.axios.get(this.Global.BASE_URL + '/camper', { params: data }).then(response => {
