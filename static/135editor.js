        UE.registerUI('135editor', function(editor, uiName) {
            ...
            console.log(editor, uiName)
            var dialog = new UE.ui.Dialog({
                // iframeUrl: 'static135EditorDialogPage.html',
                iframeUrl: '/static/135editor/dialogs/135editor/135EditorDialogPage.html',
                // iframeUrl: editor.options.UEDITOR_HOME_URL + 'dialogs/135editor/135EditorDialogPage.html',
                cssRules: "width:" + parseInt(document.body.clientWidth * 0.9) + "px;height:" + (window.innerHeight - 100) + "px;",
                editor: editor,
                name: uiName,
                title: "135编辑器"
            });
