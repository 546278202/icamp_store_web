...
(function () {
    ...
    function updateBackground () {
        if ($G('coloredRadio').checked) {
            ...
            backgroundObj["padding"] = $G("v-padding").value+" "+$G("h-padding").value;
            /*
    ...
    function setArticleBackground(backgroundObj){
    	if(backgroundObj == null) {
	    	...
	    	html = '<section class="article135" style="'+bgStyle+'">'+ innerHtml + '</section>';
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                var url = '//'+editor.getOpt('plat_host')+'/uploadfiles/ueditor?action=listimage', //editor.getActionUrl(editor.getOpt('imageManagerActionName')),
